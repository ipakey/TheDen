...
<body>
 ...
 <div class=''>
	 ...
	 <div class='spanTitleCenter'>Register for an Account</div>
			<div class='textAreaForm' style='align  : center; color:LemonChiffon; width:65%'>
					<p>Thanks for coming to this page, </br> please fill in all the fields before pressing the Sign Up button.</br> The information you proide in this form will be used for administration purposes within The Den (Kettering) only</br> and will not be shared (unless legally required) or resold for any reason. 
					</p>
			</div>
