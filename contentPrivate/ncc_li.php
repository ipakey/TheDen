		...
		<section class='rows'>
			...
			<div class='columns'>
				...
				<div class='rows'>
					...
					<button class='snackBarButton' style='width:fit-content' onclick="mashSnackbar()">Safeguarding in North Northamptonshire?</br><img class='' src='assets/images_OC/safeguardingchildren.png' style='width:200px; height:100px'></button>

					<div id="snackbar">
						<p class='pageText'>Contact the County Council Safeguarding Team
							<a class='snackBarButton' href='https://www.nctrust.co.uk/help-and-protection-for-children/Pages/report-a-concern.aspx' alt='Threasholds & Pathways site' style='text-decoration: none; color: LemonChiffon'>Go to NNC reporting webpage here. </a>
						</p>
						<p class='pageText'>Advice for Parents Page.
							<a class='snackBarButton' href='http://www.northamptonshirescb.org.uk/parents-carers/parents-mash-guide/' alt='Parents Mash site' style='text-decoration: none; color: LemonChiffon'>Go to NNC information webpage here. </a>
						</p>
						<p class='pageText'>Tell The Den of your concern.
							<a class='snackBarButton' href='forms\contactForm.php' alt='The Den Contact Form' style='text-decoration: none; color: LemonChiffon'>Go to The Den Contact form here. </br></a>
						</p>
					</div>
				</div>
		</section>
