...
<body>	
	...
	<div class='flex-container'>
		...
		<section class='rows'>
			<div class='columns'>
				<p class='pageText'>Children First Northamptonshire is part of North Northamptonshire Council duties and they provides the most difficult range of services for children in danger. </br>The Early Years team supports early years and childcare providers to deliver safe childcare. </br><img src='assets/images_OC/listenchild.png'style='float:right; height:200px'> The team of administers can support with Government funded childcare places, abuse and neglect cases and any other form of danger children might find themselves in. They also coordinate with the safeguarding of children who need extra help to have a safe, productive childhood.</br>They are part of the wider children's services teams in NCC and with partner organisations, they ensure we support the best possible outcomes for children, young people and families in the county.<br></p>
			</div>
	

			<div class='columns'>
				<div class='button' style='height:380px; width:300px; background-color: #25542b'>
					<p class='pageText' >If you are concerned about any child's welfare, please report it.<br>If a child is in immediate danger, left alone, or missing, you should contact the police and/or an ambulance directly by phoning 999.
					</p>
				</div>	
			...
			<div class='columns'>
				<div class='rows'>
					<p class='formButton' style='height:250px; width:400px; background-color: LemonChiffon; color:#25542b'>
				...
				<div class='rows'><!--snackbar -->
					
					<button class='snackBarButton' style='width:400px' onclick="mashSnackbar()"><p style='color:red; font-size:x-large'> Anything to Report?</br></br>Do it here -></p><img class='' src='assets/images_OC/safeguardingchildren.png' style='width:200px; height:100px'></button>
